...
class _AddMemoPageState extends State<AddMemoPage> {
  ...
  final _textMemoControler = TextEditingController();
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          CustomTextField(
              labelText: 'Enter event name', controller: _textMemoControler),
          SizedBox(height: 12),
          CustomTextField(
